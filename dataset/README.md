Conjunto de dados referentes às internações hospitalares, unidade de medida que representa a admissão de um paciente para ocupar um leito hospitalar, por um período igual ou maior que 24 horas.
